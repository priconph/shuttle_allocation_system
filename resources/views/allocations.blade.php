                        ...
                        <div class="card" style="margin-bottom: 80px">
                            ...
                            <div class="card-body">
                                ...
                                {{-- <div class="table-responsive"> --}}
                                    <table id="tableAlloctFrmMasterlist" class="table table-responsive table-bordered table-hover nowrap" style="width: 100%;">
                                        <thead>
                                            <tr>
                                                <th>Action</th>
                                                <th>Status</th>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            */
            ...
            dataTablesMasterlist = $("#tableAlloctFrmMasterlist").DataTable({
                "processing" : false,
                "serverSide" : true,
                "responsive": true,
                // "order": [[ 0, "desc" ],[ 4, "desc" ]],
                ...
                "ajax" : {
                    url: "view_masterlist_for_allocation",
                    data: function (param){
