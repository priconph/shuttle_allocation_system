...
use App\Exports\Sheet\OverAllSheetV4;
use App\Exports\Sheet\AllocationV4;

class ExportReportV4 implements  WithMultipleSheets
{
    use Exportable;
    ...
    public function sheets(): array {
        ...
        $sheets[] = new OverAllSheetV4($this->mergedLists);
        $sheets[] = new AllocationV4(
