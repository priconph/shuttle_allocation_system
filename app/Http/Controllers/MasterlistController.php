...
class MasterlistController extends Controller
{
            ...
            ->addColumn('masterlist_factory', function($row){
                ...
                switch ($row->masterlist_factory) {
                    ...
                    case 'F3':
                        ...
                        break;
                    default:
                        $result = '<center><span class="badge badge-pill badge-danger">FOR UPDATE</span></center>';
                        break;
                }
                return $result;
            })
       ...
       $data = $request->all();
        ...
        //     ->count();
            ...
            if ($validator->fails()) {
                ...
                if (in_array($_SESSION['rapidx_department_id'], [27, 1], true)) { // TODO:ESS and ISS Access only
                    $updateData['routes_id'] = $request->routes_id;
                    $updateData['masterlist_incoming'] =  $request->masterlist_incoming;
                    $updateData['masterlist_outgoing'] = $request->masterlist_outgoing;
                }
    ...
    public function getMasterlistById(Request $request){
        ...
        return response()->json(['masterlistData' => $masterlistData,'rapidx_department_id'=>$_SESSION['rapidx_department_id']]); //ESS & ISS
    }
